# Form implementation generated from reading ui file '..\src2\plugin\rootbuilder\ui\rootbuilder_custom.ui'
#
...
class Ui_customTabWidget(object):
    ...
    def retranslateUi(self, customTabWidget):
        ...
        self.copyModeDesc.setText(_translate("customTabWidget", "Files matching the specified rules will be copied to the game folder during a build. During a clear, the source files will be updated with any changes and the copied files are deleted."))
        ...
        self.linkModeDesc.setText(_translate("customTabWidget", "Files matching the specified rules will have links created in the game folder during build. During a clear, the source files will be updated with any changes and the links are removed."))
        ...
        self.usvfsModeDesc.setText(_translate("customTabWidget", "Files matching the specified rules will be mapped to the game folder using Mod Organizer\'s VFS. This is not compatible with all mods and will only function if Autobuild is enabled."))
