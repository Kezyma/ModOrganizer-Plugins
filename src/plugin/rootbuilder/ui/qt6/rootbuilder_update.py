# Form implementation generated from reading ui file 'D:\Repos\ModOrganizer-Plugins\src\plugin\rootbuilder\ui\rootbuilder_update.ui'
#
...
class Ui_updateTabWidget(object):
    def setupUi(self, updateTabWidget):
        ...
        updateTabWidget.resize(506, 118)
    ...
    def retranslateUi(self, updateTabWidget):
        ...
        self.checkUpdateLabel.setText(_translate("updateTabWidget", "Check for a new version of Root Builder"))
        self.noUpdateLabel.setText(_translate("updateTabWidget", "Root Builder is up to date."))
        self.updateFoundButton.setText(_translate("updateTabWidget", "Download"))
        self.updateFoundLabel.setText(_translate("updateTabWidget", "New version of Root Builder available!"))
