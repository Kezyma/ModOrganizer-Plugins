...
class Ui_customTabWidget(object):
    def setupUi(self, customTabWidget):
        ...
        self.copyModeWidget = QtWidgets.QWidget(parent=customTabWidget)
        ...
        self.copyModeTitle = QtWidgets.QLabel(parent=self.copyModeWidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.copyModeTitle.setFont(font)
        self.copyModeTitle.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.copyModeTitle.setObjectName("copyModeTitle")
        self.verticalLayout.addWidget(self.copyModeTitle)
        self.copyModeDesc = QtWidgets.QLabel(parent=self.copyModeWidget)
        ...
        self.copyModePriorityWidget = QtWidgets.QWidget(parent=self.copyModeWidget)
        ...
        self.copyModePriorityLabel = QtWidgets.QLabel(parent=self.copyModePriorityWidget)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.copyModePrioritySpin = QtWidgets.QSpinBox(parent=self.copyModePriorityWidget)
        ...
        self.copyModeTable = QtWidgets.QTableWidget(parent=self.copyModeWidget)
        self.copyModeTable.setShowGrid(True)
        self.copyModeTable.setGridStyle(QtCore.Qt.PenStyle.SolidLine)
        ...
        self.linkModeWidget = QtWidgets.QWidget(parent=customTabWidget)
        ...
        self.linkModeTitle = QtWidgets.QLabel(parent=self.linkModeWidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.linkModeTitle.setFont(font)
        self.linkModeTitle.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.linkModeTitle.setObjectName("linkModeTitle")
        self.verticalLayout_2.addWidget(self.linkModeTitle)
        self.linkModeDesc = QtWidgets.QLabel(parent=self.linkModeWidget)
        ...
        self.linkModePriorityWidget = QtWidgets.QWidget(parent=self.linkModeWidget)
        ...
        self.linkModePriorityLabel = QtWidgets.QLabel(parent=self.linkModePriorityWidget)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.linkModePrioritySpin = QtWidgets.QSpinBox(parent=self.linkModePriorityWidget)
        ...
        self.linkModeTable = QtWidgets.QTableWidget(parent=self.linkModeWidget)
        self.linkModeTable.setShowGrid(True)
        self.linkModeTable.setGridStyle(QtCore.Qt.PenStyle.SolidLine)
        ...
        self.usvfsModeWidget = QtWidgets.QWidget(parent=customTabWidget)
        ...
        self.usvfsModeTitle = QtWidgets.QLabel(parent=self.usvfsModeWidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.usvfsModeTitle.setFont(font)
        self.usvfsModeTitle.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.usvfsModeTitle.setObjectName("usvfsModeTitle")
        self.verticalLayout_3.addWidget(self.usvfsModeTitle)
        self.usvfsModeDesc = QtWidgets.QLabel(parent=self.usvfsModeWidget)
        ...
        self.usvfsModePriorityWidget = QtWidgets.QWidget(parent=self.usvfsModeWidget)
        ...
        self.usvfsModePriorityLabel = QtWidgets.QLabel(parent=self.usvfsModePriorityWidget)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.usvfsModePrioritySpin = QtWidgets.QSpinBox(parent=self.usvfsModePriorityWidget)
        ...
        self.usvfsModeTable = QtWidgets.QTableWidget(parent=self.usvfsModeWidget)
        self.usvfsModeTable.setShowGrid(True)
        self.usvfsModeTable.setGridStyle(QtCore.Qt.PenStyle.SolidLine)
    ...
    def retranslateUi(self, customTabWidget):
        ...
        self.copyModeDesc.setText(_translate("customTabWidget", "Files matching the specified rules will be copied to the game folder during a build. During a clear, the source files will be updated with any changes and the copied files are deleted. These rules support wildcards such as * and **."))
        ...
        self.linkModeDesc.setText(_translate("customTabWidget", "Files matching the specified rules will have links created in the game folder during build. During a clear, the source files will be updated with any changes and the links are removed. These rules support wildcards such as * and **."))
        ...
        self.usvfsModeDesc.setText(_translate("customTabWidget", "Files matching the specified rules will be mapped to the game folder using Mod Organizer\'s VFS. This is not compatible with all mods and does not support manual build, sync or clear. These rules support wildcards such as * and **."))
