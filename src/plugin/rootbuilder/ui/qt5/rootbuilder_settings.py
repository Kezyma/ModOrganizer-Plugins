...
class Ui_settingsTabWidget(object):
    def setupUi(self, settingsTabWidget):
        ...
        self.hashLabel = QtWidgets.QLabel(self.hashWidget)
        self.hashLabel.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
