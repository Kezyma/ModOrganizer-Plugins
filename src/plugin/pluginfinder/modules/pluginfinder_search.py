...
class PluginFinderSearch:
    ...
    def searchDirectory(self, searchTerms:str="", installed:bool=None, update:bool=None, supported:bool=None, working:bool=None, sort:str="updated", direction:str="desc") -> Dict[str, ManifestData]:
