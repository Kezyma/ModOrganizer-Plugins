...
class PluginFinder():
    ...
    def __init__(self, organiser:mobase.IOrganizer):
        ...
        self._search = PluginFinderSearch(self._organiser, self._strings, self._directory, self._util, self._log)
        self._install = PluginFinderInstall(self._organiser, self._strings, self._directory, self._util, self._log)
        super().__init__()