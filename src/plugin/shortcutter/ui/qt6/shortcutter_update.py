# Form implementation generated from reading ui file 'D:\Repos\ModOrganizer-Plugins\src\plugin\shortcutter\ui\shortcutter_update.ui'
#
...
class Ui_updateTabWidget(object):
    ...
    def retranslateUi(self, updateTabWidget):
        ...
        self.checkUpdateLabel.setText(_translate("updateTabWidget", "Check for a new version of Shortcutter"))
        self.noUpdateLabel.setText(_translate("updateTabWidget", "Shortcutter is up to date."))
        self.updateFoundButton.setText(_translate("updateTabWidget", "Download"))
        self.updateFoundLabel.setText(_translate("updateTabWidget", "New version of Shortcutter available!"))
